  ...
  return (
    <main className="mx-auto w-full max-w-7xl px-5 sm:px-8 lg:px-12 flex flex-col min-h-screen">
      ...
      <div className="flex-1 flex flex-col gap-8 py-6 sm:py-8">
        <div className="border-b border-border pb-4 flex flex-col items-start w-full">
          <Link 
            href="/" 
            className="inline-flex items-center gap-2 text-[13px] font-medium text-text-muted hover:text-foreground transition-colors outline-none mb-3 group"
          >
